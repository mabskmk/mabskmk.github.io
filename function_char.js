...
ytLink=(Math.floor(Math.random()*15));
	...
	if (ytLink==3) {ytFan='hdIbj9OGj14';} //@RamkunMUGEN
	if (ytLink==4) {ytFan='OV7sUWpTk5c';} //@RamkunMUGEN
	if (ytLink==5) {ytFan='j9qAZhX6pZI';} //@RamkunMUGEN
	if (ytLink==6) {ytFan='Ur4ExsuDbRs';} //@GetReal_EmerSensei
	if (ytLink==7) {ytFan='Y4DPg72y34s';} //@CrowSar
	if (ytLink==8) {ytFan='dWp1CJYXOs4';} //@GetReal_EmerSensei
	if (ytLink==9) {ytFan='GGrkcewCa_Q';} //@AlexNico
	if (ytLink==10) {ytFan='79fLYfG3GT4';} //@fkrmaster
...
ytLink=(Math.floor(Math.random()*2));
	if (ytLink==0) {ytFan='XcmnTRMASJI';} //@classymarowak7001
	if (ytLink==1) {ytFan='HKGtIIRkQQ0?si=soMUZDlbESVOPGEB&start=10&end=60';} //@francis_arachea
break;
case 3:
...
ytLink=(Math.floor(Math.random()*2));
	if (ytLink==0) {ytFan='4IyF2Vb3vo8';} //@CrowSar
	if (ytLink==1) {ytFan='ts4fCpiju0E';} //@multiversal-battlefield8885
break;
case 4:
...
ytLink=(Math.floor(Math.random()*4));
	if (ytLink==0) {ytFan='oF7aAZO6LYA';} //@trackiesthead1563
	if (ytLink==1) {ytFan='v27gLrZrR70';} //@HoundBlizzard
	if (ytLink==2) {ytFan='33PKSVhkaHQ?si=SegyW7znAvDGprsM&start=8&end=58';} //@mdnp-grid487
	if (ytLink==3) {ytFan='rUyfRBcs2x0?si=3flCKcCscoi5186u&start=10&end=60';} //@jewelmen10mugen87
break;
case 5:
...
ytLink=(Math.floor(Math.random()*5));
	if (ytLink==0) {ytFan='K2KNeuaCPyU?si=lDIAcYelb1086X49&start=11&end=61';} //@DavidBurgessMechanicalMusic
	if (ytLink==1) {ytFan='KJA1-8Mbd2E';} //@AlexNico
	if (ytLink==2) {ytFan='ZO9U2syXPEI';} //@OverbrakeballRises
	if (ytLink==3) {ytFan='9bgWPUKb2-0?si=GVTZiCbX-IxxyyGZ&start=12&end=62';} //@jewelmen10mugen87
	if (ytLink==4) {ytFan='drcNz_FI9lY?si=8VNj8SCJzpwecw4m&start=22&end=72';} //@Albo96_Kirbycageyt
break;
case 6:
...
ytLink=(Math.floor(Math.random()*4));
	if (ytLink==0) {ytFan='dSKlSe3mKaQ';} //@multiversal-battlefield8885
	if (ytLink==1) {ytFan='nw3hNS1tRiw';} //@no_namechannel5704
	if (ytLink==2) {ytFan='38z5GFDJtUA?si=vxxHnO56K3G30w-E&start=10&end=60';} //@francis_arachea
	if (ytLink==3) {ytFan='uF6sxHzmsv4?si=GEBoedPQLC3F9L9i&start=10&end=60';} //@mugentv7030
break;
case 8:
...
ytLink=(Math.floor(Math.random()*2));
	if (ytLink==0) {ytFan='6i36v6v6hL4?si=Qun_jPHfpnnaNZ6D&start=12&end=62';} //@trackiesthead1563
	if (ytLink==1) {ytFan='Z8NUjxFv9e8?si=tJ7m8DrOhTn-EReP&start=230&end=280';} //@Crowley9
break;
case 10:
mydiv='Captain_Kido',imgur='0IaKgex',imgur9='XQkb69u.png',game='Parotte Fighters',ctype='Char',lastupdate='18/10/11',gdrv='1hjHAwkdngFnmEBSsMlllFSPHKbQJr_u8'
	ytFan='LP_WPwfDsoA?si=GM25xYJw3Nhgklw4&start=185&end=235'; //@Vysethedetermined2
break;
case 11:
...
ytLink=(Math.floor(Math.random()*3));
	if (ytLink==0) {ytFan='x3cxVQS4As0?si=vB0qzrE1IOnHU2Xe&start=20&end=70';sufix='&autoplay=1&mute=1';} //@sonicadam2
	if (ytLink==1) {ytFan='lqz77X65QrQ?si=a15bJfmPyTGWAz06&start=25&end=75';sufix='&autoplay=1&mute=1';} //@spidermastermind100
	if (ytLink==2) {ytFan='jfgolZIE6kM?si=I5ZZpTQlyggpIziP&start=30&end=80';sufix='&autoplay=1&mute=1';} //@spidermastermind100
break;
case 12:
...
ytLink=(Math.floor(Math.random()*2));
	if (ytLink==0) {ytFan='ugFAYSHP8vI?si=aK7eUl08AQyFTozz&start=10&end=60';} //@OliverTEENAGER13
	if (ytLink==1) {ytFan='qAR1V62SSz4?si=ZJC8DCjbDbiLWsYx&start=11&end=61';} //@jewelmen10mugen87
break;
case 13:
...
ytLink=(Math.floor(Math.random()*5));
	if (ytLink==0) {ytFan='Vg3R9ORa-1s';} //@ssbk65
	if (ytLink==1) {ytFan='mpC3b-p_fLk';} //@DARKSOLODONALDAS8768
	if (ytLink==2) {ytFan='YKg5wH6T6TU';} //@trackiesthead1563
	if (ytLink==3) {ytFan='kqBPKwUkaMg?si=nvAyvEC6YnYtDYZf&start=36&end=86';} //@andersonkenya1
	if (ytLink==4) {ytFan='F7_dXn8FvS0?si=gvttUUMOfgWETg-T&start=12&end=62';} //@jewelmen10mugen87
break;
case 15:
...
ytLink=(Math.floor(Math.random()*2));
	if (ytLink==0) {ytFan='iCr6ehKIAzQ?si=6aRovBO7WiGrfeiW&start=12&end=62';} //@ristar87
	if (ytLink==1) {ytFan='VCpAig9sO-U';} //@GuiSantosMUGEN
break;
case 17:
...
ytLink=(Math.floor(Math.random()*2));
	if (ytLink==0) {ytFan='PkoYbNMsyKk';} //@DemonDragonify
	if (ytLink==1) {ytFan='EMCTifHcYYQ';} //@Aerinyxprods
break;
case 18:
mydiv='Eater-of-Worlds',imgur='rFItKdC',imgur9='entyndN.png',game='Terraria',ctype='Bonus',lastupdate='02/06/15',gdrv='1Kc2WpuZ8EoErZd8ztfJ8q1MkKMnDLKbp',bannerHtml='terraria.org',bannerImg='i.imgur.com/z4fwWXe.jpg';
	ytFan='aU2J_5lPD94'; //@DemonDragonify
break;
case 19:
...
ytLink=(Math.floor(Math.random()*2));
	if (ytLink==0) {ytFan='9KJGQkJ9SGE?si=tADnQnJ8bK7KWG4o&start=75&end=125';sufix='&autoplay=1&mute=1';} //@99Two3Eight12
	if (ytLink==1) {ytFan='aCyn7Aa_Qus';} //@francis_arachea
break;
case 20:
mydiv='Wall-of-Flesh',imgur='517R994',imgur9='HGEK7LB.gif',game='Terraria',ctype='Bonus',lastupdate='31/10/14',gdrv='1MgS3faH8veG9Xv2AyUuCEKp3EMwTn4_F',bannerHtml='terraria.org',bannerImg='i.imgur.com/z4fwWXe.jpg';
	ytFan='pm8RTgrgW8k?si=Hv68xSbWM6W2oyaO&start=20&end=70'; //@jewelmen10mugen87
break;
case 21:
...
ytLink=(Math.floor(Math.random()*6));
	if (ytLink==0) {ytFan='PUZi6vZB_RE?si=FjfOwwo0CFaFrdVV&start=25&end=75';sufix='&autoplay=1&mute=1';} //@tenshihinanawi1643
	if (ytLink==1) {ytFan='DhZE1l2KTPE';} //@JackSweg	
	if (ytLink==2) {ytFan='qTylfMYuhsA';} //@DCKnuxSADXMUGENAndMore
	if (ytLink==3) {ytFan='IyrLlm4j-50?si=GeWmbaUb_BuoCFIH&start=12&end=62';} //@jewelmen10mugen87
	if (ytLink==4) {ytFan='TZOKQOF4YqY?si=J1xeUbETlpRpW1ag&start=30&end=80';} //@spidermastermind100
	if (ytLink==5) {ytFan='jo8IPlcR7NA?si=aVBrKXtVzXZIpRRX&start=8&end=58';} //@SmokeChoked
break;
case 22:
mydiv='Murder_Wall',imgur='Bs2AFdr',imgur9='Yu4dYhl.gif',game='Kid Chameleon',ctype='Bonus',lastupdate='20/05/13',gdrv='17eXND0ylyX7igS8kho6jxz7avIIUvNE3'
	ytFan='NjT2gyb4SXE'; //@RickDangerousdanger
break;
case 23:
...
ytLink=(Math.floor(Math.random()*5));
	if (ytLink==0) {ytFan='kw6hTKReIgs';} //@I_hope_you_choke_on_em
	if (ytLink==1) {ytFan='IoxCkBt_F8g?si=jSg53mLlqCnzMIvp&start=14&end=64';} //@jewelmen10mugen87
	if (ytLink==2) {ytFan='9mi7zuM6OYQ';} //@YamiLegends
	if (ytLink==3) {ytFan='_iHnIvB3ydU';} //@DavidBurgessMechanicalMusic
	if (ytLink==4) {ytFan='HGT3hNf1bUU';} //@I_hope_you_ch0ke_on_em
break;
case 24:
...
ytLink=(Math.floor(Math.random()*9));
	if (ytLink==0) {ytFan='6VvxqbZFlcc';} //@mrbrunaco6825
	if (ytLink==1) {ytFan='LpWo9bFANwk';} //@mrbrunaco6825
	if (ytLink==2) {ytFan='40XN1-YL6Rc';} //@mrbrunaco6825
	if (ytLink==3) {ytFan='SP8Tfuptjk0';} //@mrbrunaco6825
	if (ytLink==4) {ytFan='2hbTyq3Twmc';} //@mrbrunaco6825
	if (ytLink==5) {ytFan='AlunSPki4QI';} //@mrbrunaco6825
	if (ytLink==6) {ytFan='qEYWkgtS4vQ';} //@mrbrunaco6825
	if (ytLink==7) {ytFan='hMx0SWNDM-s?si=JKL9Zqp35IEck9-n&start=12&end=62';} //@jewelmen10mugen87
	if (ytLink==8) {ytFan='GijqYq8pihw?si=QrrkidG3DGDoGgM2&start=10&end=60';} //@jewelmen10mugen87
break;
case 25:
mydiv='Dr_Wily',imgur='jiB107a',imgur9='DaMQ2Lj.png',game='Megaman',ctype='Bonus',lastupdate='21/05/13',gdrv='1i8t7TJQEw4RT7jphvoeMyTdaaT6RnKqa'
	ytFan='K0LRouSn-QE?si=1zeR4xDr1IB19cLM&start=582&end=632'; //@trackiesthead1563
break;
case 26:
...
ytLink=(Math.floor(Math.random()*5));
	if (ytLink==0) {ytFan='23D2HygrJj4';} //@MaycolGamer026
	if (ytLink==1) {ytFan='2aN1P5BFbWI';} //@DMSderProgamer
	if (ytLink==2) {ytFan='YU9aIBMQdpg';} //@davidm69
	if (ytLink==3) {ytFan='YIT80M2b8is';} //@davidm69
	if (ytLink==4) {ytFan='1oVW32ZkB2Y';} //@DartzPie
break;
case 27:
mydiv='GnG-Graveyard',imgur='p19yaAN',imgur9='5pvWAIm.png',game='Makaimura',ctype='Plataform',lastupdate='31/10/23',gdrv='1GbhV0S9ncu4Giov0mcIPTixLDmEwl6s7';
	ytPreview='abRvYTaQ47M?si=5mB9hC3_CGRlbf_w&start=355&end=405', ytFan='gKBhhIfrdRE'; //@BlackFired
break;
case 28:
mydiv='GnG-Tower',imgur='CkHRPvY',imgur9='fH7y5Ge.png',game='Makaimura',ctype='Arcade',lastupdate='31/10/23',gdrv='1UxTvsauekqFbxAh7SIFjDYTUdJuvlCtP';
	ytPreview='abRvYTaQ47M?si=EDWeUQG6sUuF--Tr&start=4&end=54', ytFan='YHdwfkEHo98?si=XWmx_3VddWQ0lMbK&start=333&end=383'; //@MannyLingle
break;
case 29:
mydiv='GnG-Burning',imgur='ScexylS',imgur9='ohZWqMw.png',game='Makaimura',ctype='SHMUP',lastupdate='31/10/23',gdrv='1GeSVB_GbPiB8PHPk5sw7HAUuJKVRAH3W';
	ytPreview='abRvYTaQ47M?si=xQA0ItQOU-TITA-H&start=83&end=133', ytFan='omEjWq8DBZ0'; //@Warblefly41
break;
case 30:
mydiv='ALEX_Jankenpon',imgur='kHBUEcQ',imgur9='i2NjJtm.png',game='Alex Kidd',ctype='JokenPo',lastupdate='01/03/12',gdrv='1o4UAIynon1lyGVFLCowRKstD-7RIxp5P'
	ytFan='3tmnr2wORuA?si=FIviXnpbOHHvdHnU&start=1178&end=1228'; //@GemeosdosJogos
break;
case 31:
...
mydiv='Castle_War',imgur='Xehem37',imgur9='aVsXFAq.png',game='Various',ctype='Tower defense',lastupdate='07/11/12',gdrv='1usRBM7HowIsEPqHnE6guEGMk3EbZO87l',ytPreview='fB1XfLCLSWk'
	ytFan='STLukVJ51VM'; //@huntergamemodification56
break;
case 33:
mydiv='Yasha-Hime',imgur='p4i3ONN',imgur9='Yg7zSMS.png',game='Ganryu',ctype='Boss',lastupdate='02/11/18',gdrv='1Dr6zJ0-Ah0ExxmRk2DfJ--burI9DMGMR';
	ytFan='gDOjf_yyshE?si=cdU--TfI_e9ufbmI&start=21&end=71'; //@trackiesthead1563
break;
case 34:
...
ytLink=(Math.floor(Math.random()*2));
	if (ytLink==0) {ytFan='rgNT2Cq9cCU';} //@jewelmen10mugen87
	if (ytLink==1) {ytFan='uOaz4uctX0k?si=7ZONmZ0BuQndJC9F&start=16&end=66';} //@jewelmen10mugen87
break;
case 35:
...
ytLink=(Math.floor(Math.random()*3));
	if (ytLink==0) {ytFan='DlOerQbikn0';} //@DemonDragonify
	if (ytLink==1) {ytFan='EN3f7x0cL7k';} //@XanderCoffin
	if (ytLink==2) {ytFan='0UrlUrO1YbE';} //@Scelua
break;
case 36:
mydiv='Captain_Kebab',imgur='TsaW1dX',imgur9='0cImMKw.png',game='Parodius',ctype='Boss',lastupdate='24/01/24',gdrv='1gGgE240lPfFJJ050h0Vk9wJlFe2c2E20';
	ytFan='z_9bj3Bv0OY?si=1v1lRBeRhYBG0s7n&start=9&end=59'; //@trackiesthead1563
break;
case 37:
mydiv='Biker_GAL',imgur='7dP9qeT',imgur9='XZyANSz.png',game='Battle_Circuit',ctype='Bonus',lastupdate='29/06/16',gdrv='1kH-OrCFQMcm_gV8_sbxoSzLhySEqFrPT'
	ytFan='NpmVTWn14Tc?si=_5_SXgRXvMJEMdtT&start=993&end=1043'; //@iconoclast575
break;
case 38:
...
mydiv='Wall_Face1-1',imgur='9uoKcu9',imgur9='T79ww2Z.png',game='Skyblazer',ctype='Boss',lastupdate='15/08/16',gdrv='1VEBZzrcjKuZ6RXTy_E0PoMgzSEO0fv24'
	ytFan='L3iArUMq1oQ?si=KGSnT7V-Ij39bz4_&start=140&end=190'; //@samuraikarasu
break;
case 40:
...
ytLink=(Math.floor(Math.random()*3));
	if (ytLink==0) {ytFan='wW_VbP0gkqI';} //@ranchsoil9387
	if (ytLink==1) {ytFan='p6D_vgRD5B8';} //@TouhouSucksYouIdiots
	if (ytLink==2) {ytFan='_45dSA02V-g?si=IXfd8DUa93i9KQxP&start=20&end=70';} //@ranchsoil9387
break;
case 41:
...
ytLink=(Math.floor(Math.random()*2));
	if (ytLink==0) {ytFan='bCUQZNA_jdA?si=Al2Syaw7MlSGG0Lv&start=286&end=336';} //@DeceasedCrab
	if (ytLink==1) {ytFan='2QISU6k8cMs';} //@Mabskmk
break;
case 42:
...
ytLink=(Math.floor(Math.random()*2));
	if (ytLink==0) {ytFan='eGHHIqf90ac';} //@XanderCoffin
	if (ytLink==1) {ytFan='6DuHP9Xz91Y?si=gA8MFHzossg5PbSU&start=1080&end1130';} //@worldoflongplays
break;
case 45:
...
ytLink=(Math.floor(Math.random()*10));
	if (ytLink==0) {ytFan='l_Hh1JuhbrM';} //@davidm69
	if (ytLink==1) {ytFan='j9Lt3i-Vf8Q';} //@CV-Mugen
	if (ytLink==2) {ytFan='cJvvlsVA4TE?si=2tMtptPr7R-4-I5M&start=272&end=322';} //@Silentgirl22
	if (ytLink==3) {ytFan='6Ksq0gJnibE';} //@davidm69
	if (ytLink==4) {ytFan='_cUM_9WVEMo';} //@CV-Mugen
	if (ytLink==5) {ytFan='MK2EJID9w6g';} //@DARKSOLODONALDAS8768
	if (ytLink==6) {ytFan='c6XKOAb5gHI?si=oqsduMNEVRlkZYHs&start=12&end=62';} //@jewelmen10mugen87
	if (ytLink==7) {ytFan='qgLOndlDzR0?si=0IqyCV94QfsjuZAW&start=23&end=73';} //@tenshihinanawi1643
	if (ytLink==8) {ytFan='aUq0eaEb4Ak?si=DHeexi5KxAGRPFmy&start=5&end=55';} //@trackiesthead1563
	if (ytLink==9) {ytFan='1h6h7rn9krM?si=n4_F9Fx9s4DGJYHJ&start=12&end=62';} //@jewelmen10mugen87
break;
case 47:
mydiv='R-Memory',imgur='RNwRj1K',imgur9='vj39rR3.png',game='R-Type',ctype='Bonus',lastupdate='31/10/20',gdrv='1PNzI6IssGK8BSsYcLCr2xSVrdiDblXVX';
	ytFan='lxuzFYhnJbI?si=9TgFK-geJ60x3wd_&start=14&end=64'; //@jewelmen10mugen87
break;
case 48:
...
ytLink=(Math.floor(Math.random()*2));
	if (ytLink==0) {ytFan='V0haA20g4_A?si=urI-6GBu2kFI8z-u&start=1576&end=1626';} //@trackiesthead1563
	if (ytLink==1) {ytFan='jFqRkTy_2hs?si=LBiWOEaVu6iqocqp&start=530&end=580';} //@LegendaryDreamerchannel
break;
case 52:
mydiv='OOM-Killer',imgur='meIJuGr',imgur9='1iC2W4S.png',game='Turrican',ctype='Bonus',lastupdate='31/10/21',gdrv='1mZm2fg8-GE29Uk61ZOPNlc7NMNy0LfJe'
	ytFan='kT01XXoHUps?si=1JKv5DQQhIgy3EXh&start=180&end=230'; //@crazyghost5357
break;
case 53:
mydiv='Sandwitch',imgur='2APcz3X',imgur9='zyTExeh.png',game='Puyo_Puyo',ctype='Bonus',lastupdate='31/10/21',gdrv='1CrFqUEl2u9or1SRXbJ5GqwpZVJ1FKtMu'
	ytFan='-XtG63ruDMM?si=j9EaI9cpo5XoyUcc&start=15&end=65'; //@jewelmen10mugen87
break;
case 54:
mydiv='Sausage_Monks',imgur='uVVlLl7',imgur9='en1KRSZ.png',game='Makaimura',ctype='Bonus',lastupdate='31/10/24',gdrv='1c43XQfrPThdtR2g1rM8kPMyrPffJeqOH'
	ytFan='0Ylj3QyWDPo?si=NW7HsFX4g9PskmnH&start=370&end=420'; //@AL82RetrogamingLongplays
break;
case 55:
...
ytLink=(Math.floor(Math.random()*3));
	if (ytLink==0) {ytFan='W9bSU1d2wME';} //@TheRatCooler
	if (ytLink==1) {ytFan='Y7FZjAm7wWw';} //@TheRatCooler
	if (ytLink==2) {ytFan='vvZEbusxgCc';} //@TheRatCooler
break;
case 56:
...
if (ytFan.length > 15) {sufix='&autoplay=1&mute=1';}
...
// document.getElementById(numero).innerHTML="<img src=https://i.imgur.com/"+imgur+".png width=25 height=25><b>"+mydiv+"</b> "+game+" / "+ctype+" / Last update: "+lastupdate+"<br><iframe src=https://www.youtube.com/embed/"+ytFan+" width='430' height='240' frameborder='0'></iframe><br><a target='_blank' href=https://drive.google.com/uc?id="+gdrv+"><img src=https://i.imgur.com/pJFCm25.png></a>"
// videoshowcase <iframe src=https://www.youtube.com/embed/"+ytFan+""+sufix+" width='500' height='300' frameborder='0'></iframe>
