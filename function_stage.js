...
rand=(Math.floor(Math.random()*3));
	if (rand==0) {youtube='YuyLAxy0cK0';}
	if (rand==1) {youtube='Fz_dcDrFMPI';}
	if (rand==2) {youtube='A9CtDo3I63c';}
break;
case 3:
...
rand=(Math.floor(Math.random()*2));
	if (rand==0) {youtube='7K0xRJ0Y1c8';}
	if (rand==1) {youtube='lAavD0tXqhg';}
break;
case 19:
...
break;
case 26:
mydiv='Moai_ruin',imgur='aen5RVb.gif',gdrv='1HCbYOLepWExO6LUFPiMweydWVgAjYCvu',bannerHtml='www.ne.jp/asahi/across/chronicle/',bannerImg='www.ne.jp/asahi/across/chronicle/image/banner.png'
rand=(Math.floor(Math.random()*2));
...
rand=(Math.floor(Math.random()*4));
	if (rand==0) {youtube='hfFLh2sXNxA';}
	if (rand==1) {youtube='hc2943nuCxY';}
	if (rand==2) {youtube='1MTegg0MLM4';}
...
rand=(Math.floor(Math.random()*5));
	if (rand==0) {youtube='ZmafphZZJWY';}
	if (rand==1) {youtube='zhFPr6GZMMY';}
	if (rand==2) {youtube='b3J-vTUuZB8';}
	if (rand==3) {youtube='jNHhyyJHyo0';}
	if (rand==4) {youtube='_vJ2cOHXWhc';}
break;
case 44:
...
break;
case 49:
mydiv='Metal_Gun',imgur='ZisA65d.gif',gdrv='1PrKFYlEcoYQD1OSgOScH_J-HNdFfKnnl',bannerHtml='www.ne.jp/asahi/across/chronicle/',bannerImg='www.ne.jp/asahi/across/chronicle/image/banner.png'
rand=(Math.floor(Math.random()*2));
...
rand=(Math.floor(Math.random()*2));
	if (rand==0) {youtube='WsnzXw-o6kA';}
	if (rand==1) {youtube='kmu04l-mjJs';}
break;
case 55:
...
rand=(Math.floor(Math.random()*2));
	if (rand==0) {youtube='z1HH-Jrun2Y';}
	if (rand==1) {youtube='txsPda-uLEY';}
break;
case 75:
...
rand=(Math.floor(Math.random()*2));
	if (rand==0) {youtube='GcNVPutPdP0';}
	if (rand==1) {youtube='JRfopQaAfM0';}
break;
case 77:
...
break;
case 83:
mydiv='Isamu_Game',imgur='xEfYQyh.gif',gdrv='1NMp-yMb7ykkUeZdbjwRKssVn0VVHLbSY',bannerHtml='www.ne.jp/asahi/across/chronicle/',bannerImg='www.ne.jp/asahi/across/chronicle/image/banner.png'
rand=(Math.floor(Math.random()*2));
...
rand=(Math.floor(Math.random()*2));
	if (rand==0) {youtube='IX61pcPc-wk';}
	if (rand==1) {youtube='1V-etDeK6uQ';}
break;
case 102:
...
rand=(Math.floor(Math.random()*2));
	if (rand==0) {youtube='wUh7-qtQLoA';}
	if (rand==1) {youtube='ov1J0GF4mzs';}
break;
case 126:
...
rand=(Math.floor(Math.random()*2));
	if (rand==0) {youtube='Fx8dVwJ9pjY';}
	if (rand==1) {youtube='g5vAdTAyDuw';}
break;
case 138:
