...
function vistg() {
rand=Math.floor(Math.random() * 146);
...
break;
case 144:
mydiv='Jiu_Xiang_Rong_Dong',imgur='mXzscPv.png',youtube='twVIILqenTM',gdrv='xxxx'
break;
case 145:
mydiv='Tietê',imgur='hVQbFCj.png',youtube='FEZyP-KRdpM',gdrv='yyyy'
break;
case 0:
mydiv=''
}
